  ...
  var result = {
    ...
    parse: function(input) {
      ...
      function parse_pseudoSelector() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(doubled, name, argument) {
      ...
      function parse_pseudoArguments() {
        var r0, r1, r2, r3, r4, r5, r6, r7;
      ...
      function parse_function() {
        ...
        r1 = pos;
        r2 = pos;
        if (input.substr(pos, 9).toLowerCase() === "@function") {
          r3 = input.substr(pos, 9);
          pos += 9;
        } else {
          r3 = null;
          if (reportFailures === 0) {
      ...
      function parse_parameterList() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(parameters, restParameter) {
        ...
        if (r0 === null) {
          r1 = pos;
          r0 = parse_restParameter();
          r0 = r0 !== null ? r0 : "";
          if (r0 !== null) {
            reportedPos = r1;
            r0 = (function(restParameter) {
          		var parameters = [];
          		if (restParameter) parameters.push(restParameter);
          		return new N('parameterList', parameters);
          	})(r0);
      ...
      function parse_mixin() {
        ...
        r1 = pos;
        r2 = pos;
        if (input.substr(pos, 6).toLowerCase() === "@mixin") {
          r3 = input.substr(pos, 6);
          pos += 6;
        } else {
          r3 = null;
      ...
      function parse_return() {
        ...
        r1 = pos;
        r2 = pos;
        if (input.substr(pos, 7).toLowerCase() === "@return") {
          r3 = input.substr(pos, 7);
          pos += 7;
        } else {
          r3 = null;
      ...
      function parse_keyframeRules() {
        var r0, r1, r2, r3, r4, r5, r6, r7, r8, r9;
        
        r1 = pos;
        r2 = pos;
        r3 = parse_keyframeRule();
        if (r3 !== null) {
          r4 = [];
          r6 = pos;
          r7 = pos;
      ...
      function parse_propertyRules() {
        var r0, r1, r2, r3, r4, r5, r6, r7, r8, r9;
        
        r1 = pos;
        r2 = pos;
        r3 = parse_propertyRule();
        if (r3 !== null) {
          r4 = [];
          r6 = pos;
          r7 = pos;
