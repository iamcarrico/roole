...
member
  = variable:variable _ '[' _ value:rawNumber _ ']' {
    return new N('member', [variable, 'value', value]);
  }
  / variable:variable _ '[' _ range:range _ ']' {
    return new N('member', [variable, 'range', range]);
  }
